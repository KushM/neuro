...
[Iappf_r,we_r] = func_remove(event2,Iappf2,Japp2,we,Iapp2);

[V2,nspikes2] = q1p2_func(1,0.5,Iappf_r,1);

figure, plot(time, Iappf_r);
xlabel('time');
ylabel('input current S2, with spikes removed')
figure, plot(time,V2);
xlabel('time');
